...
# json_file = "/home/hp/tomcat/webapps/dataHomepageSpring/resources/data/seoulMap/csv/user/test.json"

userResult = json.load(json_file)
...
# svg 파일로 저장
plt.savefig("data/result/userTest.svg")

# heatmap svg 파일 읽기
svgFile = open('data/result/userTest.svg','r')
...
# outputSvg='/home/hp/tomcat/webapps/dataHomepageSpring/resources/data/seoulMap/svg/user.svg'

# 색을 칠한 seoul map을 저장하기 위해 경로 및 이름 설정
newSeoulMap = open(outputSvg, 'w+', encoding='UTF8')
